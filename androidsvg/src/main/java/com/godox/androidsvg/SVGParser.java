...
package com.godox.androidsvg;

import android.graphics.Matrix;
import android.util.Log;
import android.util.Xml;

import com.godox.androidsvg.SVG.*;
...
Log.d(TAG,"PROC INSTR: "+parser.getText());
   ...
   public static void  processStyleProperty(Style style, String localName, String val)// throws SVGParseException
   {
   ...
   private static Style.TextDecoration parseTextDecoration(String val)
   {
      switch (val)
      {
   ...
   // Parse a text decoration keyword
   private static Style.TextDirection parseTextDirection(String val)
   {
      switch (val)
      {
   ...
   private static Style.VectorEffect parseVectorEffect(String val)
   {
      switch (val)
      {
   ...
   private static Style.RenderQuality parseRenderQuality(String val)
   {
      switch (val)
      {

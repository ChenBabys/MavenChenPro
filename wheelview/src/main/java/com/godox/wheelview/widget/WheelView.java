...
package com.godox.wheelview.widget;
...
import com.godox.wheelview.R;
import com.godox.wheelview.annotation.CurtainCorner;
import com.godox.wheelview.annotation.ItemTextAlign;
import com.godox.wheelview.annotation.ScrollState;
import com.godox.wheelview.contract.OnWheelChangedListener;
import com.godox.wheelview.contract.TextProvider;
import com.godox.wheelview.contract.WheelFormatter;
 ...
 *
 *  增加了curtainStrokeEnabled、curtainStrokeWidth属性，用于显示选中项的背景为描边矩形。
 *
...
public class WheelView extends View implements Runnable {
    ...
    protected boolean curtainStrokeEnabled;
    protected float curtainStrokeWidth;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        curtainStrokeEnabled = typedArray.getBoolean(R.styleable.WheelView_wheel_curtainStrokeEnabled, false);
        curtainStrokeWidth = typedArray.getDimension(R.styleable.WheelView_wheel_curtainStrokeWidth, 1f);
    ...
    private void drawCurtain(Canvas canvas) {
        ...
        if (curtainStrokeEnabled) {
            paint.setStyle(Paint.Style.STROKE);
            paint.setStrokeWidth(curtainStrokeWidth);
            // 保证绘制的左右边框完整
            rectCurrentItem.inset((int) curtainStrokeWidth / 2, (int) curtainStrokeWidth / 2);
        } else {
            paint.setStyle(Paint.Style.FILL);
        }
        if (curtainRadius > 0) {
